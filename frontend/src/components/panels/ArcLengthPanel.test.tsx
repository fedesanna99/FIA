    ...
    mutate: async (req: any) => {
      try {
        ...
        onSuccess?.({
          ...
          steps: [
            { step: 0, load_factor: 0, max_displacement: 0, iterations: 0,
              converged: true, arc_length: 0.01, control_displacement: 0 },
            { step: 1, load_factor: 1, max_displacement: 0.02, iterations: 4,
              converged: true, arc_length: 0.02, control_displacement: 0.02 },
          ],
          converged_all: true,
  ...
  it("submits with current params", async () => {
    ...
    (submitJob as unknown as ReturnType<typeof vi.fn>).mockResolvedValue({
      ...
      steps: [
        { step: 0, load_factor: 0, max_displacement: 0, iterations: 0,
          converged: true, arc_length: 0.01, control_displacement: 0 },
        { step: 1, load_factor: 0.5, max_displacement: 0.01, iterations: 3,
          converged: true, arc_length: 0.015, control_displacement: 0.01 },
        { step: 2, load_factor: 1.0, max_displacement: 0.02, iterations: 4,
          converged: true, arc_length: 0.02, control_displacement: 0.02 },
      ],
      converged_all: true,
      final_displacements: [], final_element_forces: [],
