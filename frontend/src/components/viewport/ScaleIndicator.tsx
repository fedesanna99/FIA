...
export function ScaleIndicator() {
  ...
  return (
    <div className="absolute bottom-3.5 left-3.5 z-10 bg-bg-panel border border-border rounded-md px-2.5 py-1.5 flex items-center gap-2 text-[10px] text-ink-muted shadow-pop font-mono pointer-events-none">
