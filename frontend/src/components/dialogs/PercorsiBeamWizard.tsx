          ...
          <div className="space-y-3" data-testid="percorsi-step-2">
            ...
            <div className="flex gap-2 pt-1">
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-xs text-ink-3 hover:text-ink rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60"
              >
